...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Check if user exists in the user data file
    $userData = file_get_contents('users.txt');
    $lines = explode(PHP_EOL, $userData);
    foreach ($lines as $line) {
        $userInfo = explode(':', $line);
        if (trim($userInfo[1]) === $name && trim($userInfo[3]) === $password) {
            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        ...
                        <a href="signup.php" class="signup-image-link">Create an account</a> <!-- Link to Sign-up page -->
                    </div>

                    <div class="signin-form">
                        <h2 class="form-title">ITech Sign In</h2>
                        <form method="PST" action="logged.php" class="register-form" id="login-form">
